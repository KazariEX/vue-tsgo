import { createCompilerError, type DirectiveNode, ElementTypes, ErrorCodes, findDir, isStaticExp, isTemplateNode, type NodeTransform, NodeTypes, type TemplateChildNode } from "@vue/compiler-dom";
...
export const transformElement: NodeTransform = (node, context) => {
  return () => {
    ...
    if (isComponent) {
      ...
      if (
        hasTemplateSlots && hasNamedDefaultSlot && implicitDefaultChildren.some(
