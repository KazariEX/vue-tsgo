import { type AttributeNode, createCompilerError, type DirectiveNode, type ElementNode, ErrorCodes, findProp, type IfBranchNode, type IfNode, NodeTypes, type SimpleExpressionNode, traverseNode } from "@vue/compiler-dom";
